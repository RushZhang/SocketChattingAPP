...
public class QqChat extends JFrame implements ActionListener {
	...
	public QqChat(String ownerId,String friend)
	{
		...
		this.setTitle(ownerId+"is talking to"+friend);
		this.add(jsp,"Center");
		this.add(jp,"South");
	...
	{
		String info=m.getSender()+" talked to "+m.getGetter()+" :  "+m.getSendTime()+"\n"+m.getConn()+"\r\n";
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==jb)
		{
			...
			String info1=m.getSender()+" talked to "+m.getGetter()+":  "+m.getSendTime()+"\n"+m.getConn()+"\r\n";
